...
bg = pygame.image.load(r'c:\Users\user\Downloads\mickey-clock.jpg')
BG_WIDTH = 500
BG_HEIGHT = 500
BG_X_POS = 0
BG_Y_POS = 0
...
big_arrow = pygame.image.load(r'c:\Users\user\Downloads\big-arrow.png')
BIG_ARROW_WIDTH = 45
...
small_arrow = pygame.image.load(r'c:\Users\user\Downloads\small-arrow.png')
SMALL_ARROW_WIDTH = 45
SMALL_ARROW_ASPECT_RATIO = 0.22
...
while running:  
  ...
  second_angle = datetime.now().second * -6
  minute_angle = datetime.now().minute * -6
  ...
  rotated_small_arrow = pygame.transform.rotate(small_arrow, minute_angle)
